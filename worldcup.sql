...
--
-- Name: teams_tim_id_seq; Type: SEQUENCE; Schema: public; Owner: freecodecamp
--

CREATE SEQUENCE public.teams_tim_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public.teams_tim_id_seq OWNER TO freecodecamp;

--
-- Name: teams_tim_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: freecodecamp
--

ALTER SEQUENCE public.teams_tim_id_seq OWNED BY public.teams.team_id;
...
ALTER TABLE ONLY public.teams ALTER COLUMN team_id SET DEFAULT nextval('public.teams_tim_id_seq'::regclass);
...
--
-- Name: teams_tim_id_seq; Type: SEQUENCE SET; Schema: public; Owner: freecodecamp
--

SELECT pg_catalog.setval('public.teams_tim_id_seq', 24, true);
